...
CREATE TABLE `studentfeedback` (
  ...
  CONSTRAINT `studentfeedback_ibfk_1` FOREIGN KEY (`StudentID`) REFERENCES `students` (`StudentID`),
  CONSTRAINT `studentfeedback_ibfk_2` FOREIGN KEY (`CourseID`) REFERENCES `courses` (`CourseID`)
...
INSERT INTO `studentfeedback` VALUES (1,1,1,'Great lecturer, very helpful'),(2,2,2,'Enjoyed the course content'),(3,3,3,'Well-organized lectures and materials');
